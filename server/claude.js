...
Ask one short open-ended question: "Before I generate your estimate — is there anything else about your project you'd like us to know? Any unique site challenges, architectural ideas, or details we didn't cover?"

Wait for their response (or if they say no/nothing, move on). Do NOT output a component here — just ask the question and wait for a text reply. Then proceed to Step 9.

### STEP 9 — Contact Info
Tell them their estimate is almost ready and you need a few details to send it.

${FENCE}json
{"component":{"type":"contact","step":9,"total_steps":10,"fields":[{"key":"first_name","label":"First Name","type":"text","placeholder":"John"},{"key":"last_name","label":"Last Name","type":"text","placeholder":"Smith"},{"key":"email","label":"Email","type":"text","placeholder":"you@email.com"},{"key":"phone","label":"Phone","type":"text","placeholder":"(512) 000-0000"},{"key":"build_location","label":"Build Location","type":"select","flex":"1 1 100%","options":[{"value":"Horseshoe Bay","label":"Horseshoe Bay"},{"value":"Kingsland","label":"Kingsland"},{"value":"Granite Shoals","label":"Granite Shoals"},{"value":"Marble Falls","label":"Marble Falls"},{"value":"Burnet","label":"Burnet"},{"value":"Llano","label":"Llano"},{"value":"Lampasas","label":"Lampasas"},{"value":"Fredericksburg","label":"Fredericksburg"},{"value":"Other Hill Country","label":"Other Hill Country"}]}],"upload_label":"Upload a floor plan, inspiration photo, or lot image (optional)","upload_hint":"Photos help our team understand your vision when they follow up."}}
${FENCE}
